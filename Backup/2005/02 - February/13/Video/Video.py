...
class Video:
	...
	def drawSimulationObject(self, theObject):
		"""Draw a simulation object where it should be."""

		glPushMatrix()
		glLoadIdentity()

		x, y, z = theObject.getPosition()

		if theObject.getAngle() > 0.0:
			glRotatef(theObject.getAngle(), 0.0, 0.0, 1.0)

		glTranslatef(x, y, z)

		displayListNum = theObject.getDrawable()
