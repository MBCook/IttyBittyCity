class Preferences:
	...
	def loadPreferences(self):
		...
		try:
			...
			raise NameError, "Unable to open the preference file."
		else:
		...
		if lines == []:
			...
			print "WARNING: Preferences: Preference file was empty."
			return
	...
	def savePreferences(self):	  
		...
		try:
			...
			raise NameError, "Unable to open file for writing."
		else:
			for key in self.prefDict.keys():
				...
				if value.__class__ == s.__class__:
					...
					print "ERROR: Preferences: Unknown type for key '" + key + "': " + value.__class__
