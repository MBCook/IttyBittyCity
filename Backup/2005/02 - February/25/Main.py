...
def main():
	...
	print "Preparing a path from '%s' to '%s'..." % (startNode, endNode)

	specialPath = pathfinder.findPath(startNode, endNode, nodeDict, distDict)
...
#	print ""
	...
	while 1:
		...
		VideoRoutines.drawSpecialPath(specialPath, nodeDict, 20.0, 1.0, 3.0)
